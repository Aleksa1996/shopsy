...
class AttachRolesToUserHandler implements CommandHandler
{
    /**
     * @var UserRepository
     */
    ...
    /**
     * AttachRolesToUserHandler constructor.
     *
     ...
     * @inheritDoc
     */
    public function execute(AttachRolesToUserCommand $command = null)
    {
